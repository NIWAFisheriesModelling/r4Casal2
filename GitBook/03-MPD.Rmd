...
## Single Model Output
```{r read_single_model, fig.width=6, fig.height=4}
...
```{r check covariance, fig.width=6, fig.height=4}
# file name
...
file_name = system.file("extdata", "estimate.log", package = "r4Casal2", mustWork = TRUE)
mpd = extract.mpd(file = file_name)
# Report labels
# names(mpd) 
