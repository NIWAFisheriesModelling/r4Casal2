...
All functions in this package should be documented using the `roxygen` format input parameters available with the `?` query. For example `?get_fisheries`. To get a list of functions and general info on the package you can use `library(help="r4Casal2")`
